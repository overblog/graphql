...
class ProfilerController
{
    ...
    public function __construct(Profiler $profiler, Environment $twig, RouterInterface $router, RequestExecutor $requestExecutor, string $queryMatch = null)
    {
    ...
    public function __invoke(Request $request, string $token): Response
    {
        ...
        return new Response($this->twig->render('@GraphQLProfiler/graphql.html.twig', [
            'request' => $request,
            'profile' => $profile,
