...
class TypeBuilder
{
    ...
    protected const EXTENDS = [
        ...
        TypeConfiguration::TYPE_ENUM => EnumType::class,
    ...
    protected RootTypeConfiguration $typeConfiguration;
     ...
     * @throws GeneratorException
     */
    protected function buildConfig(RootTypeConfiguration $config): Collection
    {
        ...
        */
        ...
        if ($config instanceof ObjectConfiguration) {
            ...
            if ($config->getResolveField() !== null) {
    ...
    protected function buildResolve($resolve, ?array $groups = null)
    {
        ...
        if (EL::isStringWithTrigger($resolve)) {
            ...
            if (false && $this->configContainsValidation()) { // XXX VALIDATION
    ...
    public function buildField(TypeConfiguration $fieldConfig, string $fieldName)
    {
        ...
        if (1 === count($fieldConfig) && isset($c->type)) {
            return $this->buildType($fieldConfig->getType());
        }*/
        ...
        if ($fieldConfig instanceof FieldConfiguration) {
            /*
            if (isset($c->validation)) {
                $field->addItem('validation', $this->buildValidationRules($c->validation));  XXX VALIDATION
            }*/
            if ($fieldConfig->getResolve() !== null) {
            ...
            if ($fieldConfig->getComplexity() !== null) {
                $field->addItem('complexity', $this->buildComplexity($fieldConfig->getComplexity()));
            }
        }
        
        /**
         * XXX Access / Public / Validation / Complexity
         *
     ...
     * @throws GeneratorException
     */
    public function buildArg(ArgumentConfiguration $argConfig): Collection
    {
