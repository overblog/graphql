...
class Configuration implements ConfigurationInterface
{
            ...
            ->children()
                ...
                ->arrayNode('types')
                    ->prototype('array')
                        ...
                        ->children()
                            ->arrayNode('types')
                                ->prototype('enum')->values(array_keys(self::SUPPORTED_TYPES_EXTENSIONS))->isRequired()->end()
                            ->end()
                            ->scalarNode('dir')->defaultNull()->end()
                            ->scalarNode('suffix')->defaultValue(self::DEFAULT_TYPES_SUFFIX)->end()
                        ->end()
                    ->end()
                ->end()
            ->end()
    ...
    private function extensionsSection(): ArrayNodeDefinition
    {
        $builder = new TreeBuilder('extensions');
        ...
        $node
            ...
            ->children()
                ->arrayNode('built_in')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->booleanNode('builder')->defaultValue(true)->end()
                        ->booleanNode('access')->defaultValue(true)->end()
                        ->booleanNode('public')->defaultValue(true)->end()
                        ->booleanNode('complexity')->defaultValue(false)->end()
                    ->end()
                ->end()
            ->end()
        ;
