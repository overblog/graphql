...
final class Mutation extends Field
{
    ...
    public function __construct(
        ...
        if ($targetTypes) {
            ...
            trigger_deprecation('overblog/graphql-bundle', '0.14', 'The attributes "targetType" on annotation @GQL\Mutation is deprecated as of 0.14 and will be removed in 1.0. Use the "targetTypes" attributes instead.');
        }
    }
}
