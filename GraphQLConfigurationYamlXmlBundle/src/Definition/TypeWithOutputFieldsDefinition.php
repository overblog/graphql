...
namespace Overblog\GraphQL\Bundle\ConfigurationYamlXmlBundle\Definition;
        ...
        $prototype
            ...
            ->children()
                ...
                ->arrayNode('argsBuilder')
                    ->beforeNormalization()
                        ->ifTrue(fn ($argsBuilder) => is_string($argsBuilder))
                        ->then(fn ($argsBuilder) => ['builder' => $argsBuilder])
                    ->end()
                    ->children()
