...
use Overblog\GraphQL\Bundle\ConfigurationGraphQLBundle\GraphQLConfigurationGraphQLBundle;
use Overblog\GraphQL\Bundle\ConfigurationMetadataBundle\GraphQLConfigurationMetadataBundle;
use Overblog\GraphQL\Bundle\ConfigurationYamlXmlBundle\GraphQLConfigurationYamlXmlBundle;
...
final class TestKernel extends Kernel implements CompilerPassInterface
{
    ...
    public function registerBundles()
    {
        ...
        yield new GraphQLConfigurationYamlXmlBundle();
        yield new GraphQLConfigurationGraphQLBundle();
