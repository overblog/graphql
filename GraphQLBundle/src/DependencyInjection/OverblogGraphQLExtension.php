...
use Overblog\GraphQLBundle\Extension\Builder\Builder\RelayConnectionFieldsBuilder;
use Overblog\GraphQLBundle\Extension\Builder\Builder\RelayEdgeFieldsBuilder;
...
class OverblogGraphQLExtension extends Extension
{
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $this->registerExtensions($config, $container);
    ...
    {
        if (empty($config['definitions']['mappings']['auto_discover']['built_in'])) {
            $container->removeDefinition('Overblog\GraphQLBundle\Configuration\Type\PageInfoConfiguration');
        }
    }

    private function registerExtensions(array $config, ContainerBuilder $container): void
    {
    }
